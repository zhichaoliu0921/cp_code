...
(-2.75, 8.75): {'ind': 15, 'radius': 0.58}, (3.25, 0.25): {'ind': 27, 'radius': 0.58}}
    ...
    collision_info_dict_adjust = traj_pattern_gen.generate_traj_pattern(v_max*0.707, a_max, pos_recover_prop,
                                                                        vel_recover_prop)
    ...
    for ind in index_list:
        ...
        if collision_state[ind] == 1:
            traj_temp = trajGenerator(waypoints_temp, vel_st, vel_ed, max_vel=v_max*0.707, gamma=1e3)
        else:
